...
This [unofficial*](#power) Scala/Lift basic assembly example project demonstrates a very basic squeryl-record ORM/DSL User (authentication/authorization) setup 
...
<h1 id="power">User powered basic example</h1>
